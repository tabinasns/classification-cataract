...
model_katarak = tf.keras.models.load_model('model/model_mobilenet_katarak.h5', compile=False)
model_fundus = tf.keras.models.load_model('model/model_mobilenet_fundus.h5', compile=False)
